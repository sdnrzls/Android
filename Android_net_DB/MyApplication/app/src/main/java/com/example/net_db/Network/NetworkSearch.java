...
import com.example.net_db.UserInfo;
...
public class NetworkSearch extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Adress = "http://10.100.206.29:8888/testWeb/testDB3_search.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            buffer.append("word").append("=").append(strings[0]);
    ...
    protected void onPostExecute(String s) {
        ...
        int conut = 0;
        try {
            conut = JsonPaser.getUserInfoJson(s, userList);
