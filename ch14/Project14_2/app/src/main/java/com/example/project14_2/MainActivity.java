            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                switch (status){
                    case BatteryManager.BATTERY_STATUS_CHARGING:
                        Toast.makeText(getApplicationContext(),"배터리 충전 중 입니다.",Toast.LENGTH_SHORT).show();
                        break;
                    case BatteryManager.BATTERY_STATUS_NOT_CHARGING:
                        Toast.makeText(getApplicationContext(),"배터리 충전되지 않았습니다.",Toast.LENGTH_SHORT).show();
                        break;
                    case BatteryManager.BATTERY_STATUS_DISCHARGING:
                        Toast.makeText(getApplicationContext(),"배터리가 방전되었습니다.",Toast.LENGTH_SHORT).show();
                        break;
                    case BatteryManager.BATTERY_STATUS_FULL:
                        Toast.makeText(getApplicationContext(),"배터리 충전이 완료되었습니다.",Toast.LENGTH_SHORT).show();
                        break;
                    case BatteryManager.BATTERY_STATUS_UNKNOWN:
                        Toast.makeText(getApplicationContext(),"배터리 상태를 확인할수 없습니다.",Toast.LENGTH_SHORT).show();
                        break;
                }
