...
public class MovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        intent= getIntent();
        tvid.setText(intent.getStringExtra("userid"));
        ...
        for(int i=0; i<imageId.length; i++){
            ...
            image[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final View dlgView = (View) View.inflate(MovieActivity.this,R.layout.time,null);
                    //다이얼로그 생성
                    AlertDialog.Builder dg = new AlertDialog.Builder(MovieActivity.this);
                    dg.setTitle((index+1)+"관 \n"+
                            imgName[index]+" 영화 시간");
                    //다이얼로그에 뷰 지정
                    dg.setView(dlgView);
                    //버튼 이벤트
                    dg.setPositiveButton("시간선택완료", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //인텐트 설정 (현위치,보낼위치)
                            Intent intent = new Intent(getApplicationContext(),MovieActivity_2.class);
